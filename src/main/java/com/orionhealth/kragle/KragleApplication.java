...
import com.orionhealth.kragle.services.TourService;
import com.orionhealth.kragle.services.TourPackageService;
...
public class KragleApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(KragleApplication.class, args);
	}
